(ns net.wikipunk.rdf.cmns-cds
  ...
  {:cmns-av/copyright ["Copyright (c) 2021-2022 agnos.ai U.K. Ltd"
   ...
   :owl/versionIRI
   "https://www.omg.org/spec/Commons/20221101/CodesAndCodeSets/",
   :rdf/ns-prefix-map
   ...
   :rdf/uri "https://www.omg.org/spec/Commons/CodesAndCodeSets/",
...
(def CodeSet
  ...
  {:cmns-av/synonym "coding scheme",
   ...
   :rdf/type :owl/Class,
   :rdfs/label "code set",
   :rdfs/subClassOf [{:owl/allValuesFrom :cmns-cds/CodeElement,
