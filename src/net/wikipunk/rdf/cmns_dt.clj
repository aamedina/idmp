(ns net.wikipunk.rdf.cmns-dt
  ...
  {:cmns-av/copyright ["Copyright (c) 2014-2022 Thematix Partners LLC"
   ...
   :owl/versionIRI "https://www.omg.org/spec/Commons/20221101/DatesAndTimes/",
   :rdf/ns-prefix-map
   ...
   :rdf/uri "https://www.omg.org/spec/Commons/DatesAndTimes/",
   :rdfa/prefix "cmns-dt",
...
(def DatePeriod
  "time span over one or more calendar days"
...
(def ExplicitDate
  "date in which the 'has date value' property is required"
...
(def hasEndDate
  "indicates the ending date of some date period"
